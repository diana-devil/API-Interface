...
import com.diana.api.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.diana.api.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.diana.api.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Boolean> deleteUserInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!(oldUserInterfaceInfo.getUserId() == user.getId()) && !userService.isAdmin(request)) {
    ...
    public BaseResponse<UserInterfaceInfo> getUserInterfaceInfoById(long id) {
        ...
        ThrowUtils.throwIf(userInterfaceInfo == null, ErrorCode.NOT_FOUND_ERROR, "接口不存在");
